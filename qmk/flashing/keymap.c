...
/* _QWERTY
   ,------------------------------------------------,	,------------------------------------------------,
   | Esc  |   1  |   2  |   3  |   4  |   5  |      |	| PGUP |   6  |   7  |  8   |   9  |   0  | BKSPC|
   |------+------+------+------+------+------+------|	|------+------+------+------+------+------+------|
   ...
   |------+------+------+------+------+------+------|	|------+------+------+------+------+------+------|
   | Ctrl | Home | End  |  ALT | MO(1)| Spce |      | | ENTER| Spce |  -_  |  +=  |  {[  |  }]  |  ~`  |
   `------------------------------------------------`	`------------------------------------------------`
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		KC_ESC,  KC_1,    KC_2,   KC_3,    KC_4,  KC_5,   KC_NO,                  KC_PGUP, KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, 
		...
		KC_LCTL, KC_HOME, KC_END, KC_LALT, LOWER, KC_SPC, KC_NO,                  KC_ENT,  KC_SPC, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_GRV),
	[_LOWER] = LAYOUT(
